...
namespace ColegioWeb.Controllers
{
    public class MateriasController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("MateriaId,Nombre,Descripcion")] Materia materia)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("MateriaId,Nombre,Descripcion")] Materia materia)
        {
